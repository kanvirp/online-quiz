...
else
{
    ...
    <table style="margin-left: 10px;">
        ...
        <tr>
            <td>
                <input type="radio" name="r2" id="r2" value="<?php echo $opt2; ?>" onclick="radioclick(this.value,<?php echo $question_no ?>)"
                <?php 
                if($ans==$opt2)
                {
                    echo "checked";
        ...
        <tr>
            <td>
                <input type="radio" name="r3" id="r3" value="<?php echo $opt3; ?>" onclick="radioclick(this.value,<?php echo $question_no ?>)"
                <?php 
                if($ans==$opt3)
                {
                    echo "checked";
        ...
        <tr>
            <td>
                <input type="radio" name="r4" id="r4" value="<?php echo $opt4; ?>" onclick="radioclick(this.value,<?php echo $question_no ?>)"
                <?php 
                if($ans==$opt4)
                {
                    echo "checked";
